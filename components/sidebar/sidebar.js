...
import { sidebar_menus } from "@/assets/sidebar-menu";
            ...
            <div className="bg-white border-r shadow-sm">
                ...
                <div className="py-3">
                    ...
                    <div className="text-center">
                        <p className="text-md font-semibold pt-2">Black Monter</p>
                        <a href="" className="text-md text-[#087E8B]">blackmonter@gmail.com</a>
                        ...
                        <nav className="mt-2 space-y-1">
                            {
                                sidebar_menus.map((menu, index) => (
                                    <NavbarLink key={index} {...menu} />
                                ))
                            }

                        </nav>
                        <div className=" ">
                            <Link href="#" className="flex items-center px-4 py-2 mt-6
                                rounded-xl text-sm font-medium text-[#0B3954]  bg-gray-300">
                                <svg
                                    width={25}
                                    height={24}
                                    viewBox="0 0 25 24"
